...
import "piccolore";
import { P as renderTemplate, B as renderSlot, aZ as renderHead, a2 as addAttribute, aY as defineScriptVars, y as maybeRenderHead } from "./sequence_BSVkO_8S.mjs";
import "clsx";
import { g as generateSafeId } from "./index_COh8w1AS.mjs";
...
const ui = {
  es: {
    ...
    "serv.1.d1.t": "Arquitectura Headless",
    "serv.1.d1.d": "Desacoplamos el front-end usando React y Next.js para una velocidad de carga insuperable.",
    "serv.1.d2.t": "Custom Native Themes",
    "serv.1.d2.d": "Programación Liquid profunda en Shopify Plus para tiendas monolíticas de alta eficiencia.",
    "serv.1.d3.t": "Checkout Engineering",
    "serv.1.d3.d": "Modificación de la página de pago para integrar flujos nativos de Upsell y Cross-sell.",
    "serv.1.d4.t": "Migración Enterprise",
    "serv.1.d4.d": "Transiciones seguras desde Magento o VTEX conservando datos, SEO y lógica de clientes.",
    "serv.1.t1": "Shopify Plus",
    "serv.1.t2": "Next.js / Hydrogen",
    "serv.1.t3": "Vercel",
    ...
    "serv.2.d1.t": "Portales Cerrados",
    "serv.2.d1.d": "Sistemas de acceso autenticado exclusivos para distribuidores con catálogos protegidos.",
    "serv.2.d2.t": "Reglas Dinámicas",
    "serv.2.d2.d": "Algoritmos de precios por volumen, net terms y asignación de crédito automatizada.",
    "serv.2.d3.t": "Sistemas Quick-Order",
    "serv.2.d3.d": "Interfaces de re-pedido ágil por SKU para compras masivas sin fricción de navegación.",
    "serv.2.d4.t": "Sincronización Multi-Almacén",
    "serv.2.d4.d": "Ruteo inteligente de órdenes basado en la disponibilidad de inventario en tiempo real.",
    "serv.2.t1": "Shopify B2B",
    "serv.2.t2": "Custom APIs",
    "serv.2.t3": "ERP Connect",
    ...
    "serv.3.d1.t": "Integración ERP Nativa",
    "serv.3.d1.d": "Conexión bidireccional con SAP, NetSuite o Microsoft Dynamics vía APIs personalizadas.",
    "serv.3.d2.t": "Arquitectura de Bases",
    "serv.3.d2.d": "Construcción de centros de comando en Airtable para control operativo centralizado.",
    "serv.3.d3.t": "Automatización de Flujos",
    "serv.3.d3.d": "Orquestación de procesos complejos mediante Make (Integromat) y webhooks nativos.",
    "serv.3.d4.t": "Logística de Fulfillment",
    "serv.3.d4.d": "Conexión automatizada con sistemas WMS y centros de distribución (3PL).",
    "serv.3.t1": "Make",
    "serv.3.t2": "Airtable",
    "serv.3.t3": "Webhooks / REST",
    ...
    "serv.4.d1.t": "Auditoría Técnica UX",
    "serv.4.d1.d": "Mapeo forense de fricciones en el embudo de compra y rendimiento del servidor.",
    "serv.4.d2.t": "A/B Testing Continuo",
    "serv.4.d2.d": "Pruebas iterativas sobre elementos críticos para garantizar el incremento del AOV.",
    "serv.4.d3.t": "Análisis de Comportamiento",
    "serv.4.d3.d": "Despliegue de mapas de calor y grabaciones de sesión para validar hipótesis de diseño.",
    "serv.4.d4.t": "Retención Avanzada",
    "serv.4.d4.d": "Ingeniería de flujos de automatización en Klaviyo para maximizar la recompra.",
    "serv.4.t1": "Klaviyo",
    "serv.4.t2": "Hotjar",
    "serv.4.t3": "Google Analytics 4",
    ...
    "serv.choose.1.title": "Cero Deuda Técnica",
    "serv.choose.1.desc": "No usamos plantillas ni llenamos tu tienda de aplicaciones basura. Escribimos código modular y limpio que permite escalar la operación sin que los sistemas colapsen bajo presión.",
    "serv.choose.2.title": "Expertise Singular",
    "serv.choose.2.desc": "No hacemos redes sociales, no hacemos campañas de branding. Somos una firma obsesionada exclusivamente con la arquitectura transaccional y la ingeniería de conversión.",
    "serv.choose.3.title": "Metodología Predictiva",
    "serv.choose.3.desc": "Nuestras decisiones de diseño e infraestructura no se basan en opiniones estéticas, se basan en análisis de datos cuantitativos, patrones de usuario y métricas de rendimiento.",
    // ==========================================
    // NOSOTROS — Rediseñado
    // ==========================================
    // Hero
    ...
    "about.m1.num": "0",
    "about.m1.sym": "ms",
    "about.m1.desc": "Tolerancia a deuda técnica. Código nativo puro, sin parches.",
    "about.m2.num": "99",
    "about.m2.sym": ".9%",
    "about.m2.desc": "Uptime garantizado en infraestructuras Headless.",
    "about.m3.num": "34",
    "about.m3.sym": "%",
    "about.m3.desc": "Aumento promedio documentado en Conversion Rate.",
    "about.m4.num": "10",
    "about.m4.sym": "+",
    "about.m4.desc": "Sistemas ERP (SAP/NetSuite) integrados en tiempo real.",
    "about.m5.num": "50",
    "about.m5.sym": "M+",
    "about.m5.desc": "Revenue anual orquestado a través de nuestros sistemas.",
    "about.m6.num": "100",
    "about.m6.sym": "%",
    "about.m6.desc": "Decisiones UX respaldadas exclusivamente por data real.",
    // ¿Por qué Flouvia?
  ...
  en: {
    ...
    "tech.title": "Our",
    "tech.title_editorial": "technology.",
    ...
    "proto.title": "Execution",
    "proto.title_editorial": "Protocol.",
    ...
    "serv.why.1.title": "Performance",
    "serv.why.1.desc": "Server-level optimization for instant loading.",
    "serv.why.2.title": "Scalability",
    "serv.why.2.desc": "Modular code ready for global traffic.",
    "serv.why.3.title": "Conversion",
    "serv.why.3.desc": "UX based on data and buying patterns.",
    ...
    "serv.1.d1.t": "Headless Architecture",
    "serv.1.d1.d": "Decoupling the front-end using React and Next.js for unbeatable loading speeds.",
    "serv.1.d2.t": "Custom Native Themes",
    "serv.1.d2.d": "Deep Liquid programming in Shopify Plus for high-efficiency monolithic stores.",
    "serv.1.d3.t": "Checkout Engineering",
    "serv.1.d3.d": "Checkout page modification to integrate native Upsell and Cross-sell flows.",
    "serv.1.d4.t": "Enterprise Migration",
    "serv.1.d4.d": "Secure transitions from Magento or VTEX preserving data, SEO, and logic.",
    "serv.1.t1": "Shopify Plus",
    "serv.1.t2": "Next.js / Hydrogen",
    "serv.1.t3": "Vercel",
    ...
    "serv.2.d1.t": "Closed Portals",
    "serv.2.d1.d": "Authenticated access systems exclusive to distributors with protected catalogs.",
    "serv.2.d2.t": "Dynamic Rules",
    "serv.2.d2.d": "Volume pricing algorithms, net terms, and automated credit allocation.",
    "serv.2.d3.t": "Quick-Order Systems",
    "serv.2.d3.d": "Agile re-ordering interfaces by SKU for massive purchases without friction.",
    "serv.2.d4.t": "Multi-Warehouse Sync",
    "serv.2.d4.d": "Intelligent order routing based on real-time inventory availability.",
    "serv.2.t1": "Shopify B2B",
    "serv.2.t2": "Custom APIs",
    "serv.2.t3": "ERP Connect",
    ...
    "serv.3.d1.t": "Native ERP Integration",
    "serv.3.d1.d": "Two-way connection with SAP, NetSuite, or Microsoft Dynamics via custom APIs.",
    "serv.3.d2.t": "Database Architecture",
    "serv.3.d2.d": "Building command centers in Airtable for centralized operational control.",
    "serv.3.d3.t": "Workflow Automation",
    "serv.3.d3.d": "Orchestrating complex processes using Make (Integromat) and native webhooks.",
    "serv.3.d4.t": "Fulfillment Logistics",
    "serv.3.d4.d": "Automated connection with WMS systems and distribution centers (3PL).",
    "serv.3.t1": "Make",
    "serv.3.t2": "Airtable",
    "serv.3.t3": "Webhooks / REST",
    ...
    "serv.4.d1.t": "Technical UX Audit",
    "serv.4.d1.d": "Forensic mapping of frictions in the purchase funnel and server performance.",
    "serv.4.d2.t": "Continuous A/B Testing",
    "serv.4.d2.d": "Iterative testing on critical elements to guarantee an increase in AOV.",
    "serv.4.d3.t": "Behavioral Analysis",
    "serv.4.d3.d": "Deployment of heatmaps and session recordings to validate design hypotheses.",
    "serv.4.d4.t": "Advanced Retention",
    "serv.4.d4.d": "Engineering automation flows in Klaviyo to maximize repeat purchases.",
    "serv.4.t1": "Klaviyo",
    "serv.4.t2": "Hotjar",
    "serv.4.t3": "Google Analytics 4",
    ...
    "serv.choose.1.title": "Zero Technical Debt",
    "serv.choose.1.desc": "We don't use templates or fill your store with garbage apps. We write clean, modular code that allows the operation to scale without systems collapsing under pressure.",
    "serv.choose.2.title": "Singular Expertise",
    "serv.choose.2.desc": "We don't do social media, we don't do branding campaigns. We are a firm exclusively obsessed with transactional architecture and conversion engineering.",
    "serv.choose.3.title": "Predictive Methodology",
    "serv.choose.3.desc": "Our design and infrastructure decisions aren't based on aesthetic opinions; they are based on quantitative data analysis, user patterns, and performance metrics.",
    // ==========================================
    // NOSOTROS 
    // ==========================================
    // Hero
    ...
    "about.m1.num": "0",
    "about.m1.sym": "ms",
    "about.m1.desc": "Tolerance for technical debt. Pure native code, no patches.",
    "about.m2.num": "99",
    "about.m2.sym": ".9%",
    "about.m2.desc": "Guaranteed uptime in Headless infrastructures.",
    "about.m3.num": "34",
    "about.m3.sym": "%",
    "about.m3.desc": "Average documented increase in Conversion Rate.",
    "about.m4.num": "10",
    "about.m4.sym": "+",
    "about.m4.desc": "ERP systems (SAP/NetSuite) integrated in real time.",
    "about.m5.num": "50",
    "about.m5.sym": "M+",
    "about.m5.desc": "Annual revenue orchestrated through our systems.",
    "about.m6.num": "100",
    "about.m6.sym": "%",
    "about.m6.desc": "UX decisions backed exclusively by real data.",
    // Why Flouvia
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["<html", `> <head><meta charset="UTF-8"><meta name="description" content="Flouvia Boutique - Engineering & Growth"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"><link id="favicon-tag" rel="icon" type="image/svg+xml" href="/favicon-light.svg"><link rel="apple-touch-icon" href="/favicon-light.svg"><script>
  // Función para cambiar el favicon manualmente
  ...
  // Escuchar si el usuario cambia el modo mientras tiene la página abierta
  window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', updateFavicon);
<\/script><link rel="apple-touch-icon" href="/favicon-light.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet"><meta name="theme-color" content="#ffffff"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><title>`, "</title>", "</head> <body> ", "</body></html>"])), addAttribute(lang, "lang"), title, renderHead(), renderSlot($$result, $$slots["default"]));
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/layouts/Layout.astro", void 0);
...
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/node_modules/@clerk/astro/components/interactive/InternalUIComponentRenderer.astro", void 0);
export {
