...
export const ui = {
  es: {
    ...
    'entorno.eyebrow': 'ENTORNO EN PRODUCCIÓN',
    'entorno.title': 'Entorno',
    'entorno.title_ed': 'en Vivo.',
    'entorno.subtitle': 'Estado en tiempo real de tu infraestructura desplegada.',
  ...
  en: {
    ...
    // PORTAL ENTORNO
    'entorno.back': '← Dashboard',
    'entorno.eyebrow': 'LIVE ENVIRONMENT',
    'entorno.title': 'Live',
    'entorno.title_ed': 'Environment.',
    'entorno.subtitle': 'Real-time status of your deployed infrastructure.',
