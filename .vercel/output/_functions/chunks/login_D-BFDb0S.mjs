...
const $$Login = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (host === "flouvia.com" || host === "www.flouvia.com") {
    return Astro2.redirect("https://os.flouvia.com/en/login", 302);
  }
  const { userId } = await Astro2.locals.auth();
  if (userId) {
    return Astro2.redirect("/en/dashboard");
  }
...
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/login.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/login.astro";
const $$url = "/en/login";
