...
const $$Calendario = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PortalLayout", $$PortalLayout, { "title": "Calendar | Flouvia OS" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "CalendarioUI", $$CalendarioUI, { "lang": "en" })} ` })}`;
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/portal/calendario.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/portal/calendario.astro";
const $$url = "/en/portal/calendario";
