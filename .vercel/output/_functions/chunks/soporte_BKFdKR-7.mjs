...
const $$Soporte = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PortalLayout", $$PortalLayout, { "title": "Soporte VIP | Flouvia OS" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "SoporteUI", $$SoporteUI, { "lang": "es" })} ` })}`;
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/portal/soporte.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/portal/soporte.astro";
const $$url = "/portal/soporte";
