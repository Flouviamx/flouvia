...
const $$Facturacion = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PortalLayout", $$PortalLayout, { "title": "Billing | Flouvia OS" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "FacturacionUI", $$FacturacionUI, { "lang": "en" })} ` })}`;
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/portal/facturacion.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/portal/facturacion.astro";
const $$url = "/en/portal/facturacion";
