...
const $$Entorno = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PortalLayout", $$PortalLayout, { "title": "Environment | Flouvia OS" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "EntornoUI", $$EntornoUI, { "lang": "en" })} ` })}`;
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/entorno.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/en/entorno.astro";
const $$url = "/en/entorno";
