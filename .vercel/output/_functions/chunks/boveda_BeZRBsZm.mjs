...
const $$Boveda = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PortalLayout", $$PortalLayout, { "title": "Bóveda | Flouvia OS" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "BovedaUI", $$BovedaUI, { "lang": "es" })} ` })}`;
}, "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/portal/boveda.astro", void 0);
const $$file = "/Users/andrevalleortega/Desktop/Flouvia-Web/Flouvia-Web/src/pages/portal/boveda.astro";
const $$url = "/portal/boveda";
